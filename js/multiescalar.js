...
var nummult = parseInt(prompt("Digite o numero escalar"))
while (isNaN(nummult)) {
    alert("Valor Invalido")

    nummult = parseInt(prompt("Digite o numero escalar"))
}
...
for (i = 0; i < coluna; i++) {
    ...
    for (j = 0; j < linha; j++) {
        result[i][j] = matriz1[i][j] * nummult;
    }
...
document.write("<h1> Numero Escalar:</h1>")

document.write("<br>")

document.write("<h2>("+nummult+")</h2>")
